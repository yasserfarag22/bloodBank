    ...
    <div class="">
        <div class="card box-shadow-0">
            <div class="card-header">
                <h4 class="card-title mb-1">تعديل مقال</h4>
            ...
            <div class="card-body pt-0">
                <form action="{{ route('posts.update', $post->id) }}" method="POST" class="form-horizontal"
                    ...
                    <div class="form-group">
                        ...
                        @if ($post->image)
                            <img src="{{ asset('/img/posts/' . $post->image) }}" alt="صورة المقالة"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="content" id="inputContent" rows="5" placeholder="محتوى المقالة" required>{{ old('content', $post->content) }}</textarea>
                    </div>
